...
class ParentAdminView(AdminModelView):
    # Use a custom edit template (we will create this next)
    edit_template = 'admin/parent_edit.html'

    # --- (form_extra_fields, form_overrides, etc. remain the same) ---
    form_extra_fields = {
    ...
    def edit_form(self, obj=None):
        """
        Override edit_form to inject the current image URL into the form field's
        render_kw dictionary. This is the correct way to pass data to the template.
        """
